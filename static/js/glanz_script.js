(function($) {
  ...
  /*OWL Team*/
	...
	$('.gla_parent a').on("click", function(e){
		$('.gla_main_menu').next('.gla_main_menu_content').removeClass('active');
		$('.gla_main_menu').next().next('.gla_main_menu_content_menu').removeClass('active');
